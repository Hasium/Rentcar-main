                                                ...
                                                <c:choose>
                                                    <c:when test="${vehicle.id() == rent.vehicle_id()}">
                                                        <option value="${vehicle.id()}"
                                                                selected>${vehicle.constructeur()} ${vehicle.modele()}</option>
                                                    </c:when>
                                                    <c:otherwise>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="begin" name="begin"
                                               value="${rent.debut().getDayOfMonth()}/${rent.debut().getMonthValue()}/${rent.debut().getYear()}"
                                               required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="end" name="end"
                                               value="${rent.fin().getDayOfMonth()}/${rent.fin().getMonthValue()}/${rent.fin().getYear()}"
                                               required
                                               data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                    </div>
                                </div>
